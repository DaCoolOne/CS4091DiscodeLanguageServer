...
{
  "$end", "error", "$undefined", "KEYWORD_IF", "KEYWORD_WHILE",
  "KEYWORD_RETURN", "KEYWORD_DECLARE", "KEYWORD_FUNCTION",
  "KEYWORD_METHOD", "KEYWORD_NULL", "KEYWORD_TRUE", "KEYWORD_FALSE",
  "KEYWORD_AND", "KEYWORD_OR", "KEYWORD_NOT", "NUMBER", "STRING",
  "IDENTIFIER", "OPERATOR_EQ", "OPERATOR_NEQ", "OPERATOR_LSEQ",
  "OPERATOR_GTEQ", "OPERATOR_ASSIGN", "OPERATOR_ADD", "OPERATOR_SUB",
  "OPERATOR_MUL", "OPERATOR_DIV", "OPERATOR_LSS", "OPERATOR_GTR",
  "OPERATOR_DOT", "OPERATOR_COMMA", "OPERATOR_POUND", "OPERATOR_EXCLAM",
  "OPERATOR_COLON", "OPERATOR_SEMICOLON", "OPERATOR_OPEN_BRACE",
  "OPERATOR_CLOSE_BRACE", "OPERATOR_OPEN_PAREN", "OPERATOR_CLOSE_PAREN",
  "$accept", "START", "FUNCTION", "METHOD", "DECLARE", "CODE_BLOCK",
  "STATEMENT_LIST", "STATEMENT", "FUNCTION_CALL", "ARGUMENT_LIST",
  "ARGUMENT_REP", "IDENTIFIER_LIST", "IDENTIFIER_REP", "FULL_IDENTIFIER",
  "IDENTIFIER_PATH", "EXPRESSION", "UNARY_BOOL_EXPR", "OR_EXPR",
  "AND_EXPR", "COMP_EXPR", "ADD_EXPR", "MUL_EXPR", "UNARY_MINUS",
  "TERMINAL", 0
};
#endif

...
void load(discode::VM * vm, AST_Node * node, std::string channel, std::string msg_id, std::string ch_id);
void loadVM(discode::VM * vm, std::string channel, std::string path, std::string msg_id, std::string ch_id);
void loadVM_string(discode::VM * vm, std::string channel, std::string str, std::string msg_id, std::string ch_id);

...
{
public:
    JsonNull(): JsonData(JSON_DATA_NULL) {}
...
class JsonBool: public JsonData
{
    bool _data;
public:
    JsonBool(bool value): JsonData(JSON_DATA_BOOL), _data(value) {}
...
class JsonNumber: public JsonData
{
    double _data;
public:
    JsonNumber(double value): JsonData(JSON_DATA_NUMBER), _data(value) {}
...
class JsonString: public JsonData
{
    std::string _data;
public:
    JsonString(std::string value): JsonData(JSON_DATA_STRING), _data(value) {}
...
public:
    JsonArray(): JsonData(JSON_DATA_ARRAY) {}
...
public:
    JsonObject(): JsonData(JSON_DATA_OBJECT) {}
